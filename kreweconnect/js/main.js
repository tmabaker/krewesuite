/* ============================================
   KreweConnect Landing Page — Main JS
...
(function () {
    ...
    if (form) {
        form.addEventListener('submit', (e) => {
            ...
            try {
                const submissions = JSON.parse(localStorage.getItem('kreweconnect_submissions') || '[]');
                submissions.push(data);
                localStorage.setItem('kreweconnect_submissions', JSON.stringify(submissions));
            } catch (err) {
                // localStorage might be full or disabled — proceed anyway
